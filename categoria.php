    ...
    <div class="dividir">
        ...
        <div class="comentarios-sesenta">
            <div class="fondo-marcas">
                <h1 class="mayus fw-200">Comentarios de <span><?= $categoria_actual['nombre'] ?></span> </h1>

                <?php $entradas = conseguirEntradas($db, null, $_GET['id']);
                if (!empty($entradas) && mysqli_num_rows($entradas) >= 1) : ?>
                    <?php while ($entrada_actual = mysqli_fetch_assoc($entradas)) : ?>
                    ...
                    <div class="contenedor invitacion">
                        <p>No se encontraron comentarios de <span><?= $categoria_actual['nombre'] ?></span> </p>
                        <p>Cree un comentario acerca de esta categoria de forma sencilla y sin costo</p>
                        <?php if (isset($_SESSION['usuario'])) : ?>
                            <a class="btn-general" href="./crear-entradas.php">Crear Comentario <i class="fas fa-angle-right"></i></a>
                        <?php endif; ?>

                        <?php if (!isset($_SESSION['usuario'])) : ?>
                            <a class="btn-general" href="login-required.php">Crear Comentario <i class="fas fa-angle-right"></i></a>
                        <?php endif; ?>
        ...
        <div class="barra-externos-veinte">
            ...
            ?>
                    ...
                    <div class="comentario-secundario">
                        ...
                        <div class="descripcion">
                            <?= substr($entrada_actual['descripcion'], 0, 100) . " saber más"  ?>
                        </div>
                    </div>
                    <?php ?>
                <?php endwhile; ?>

...
<?php
$entradas = conseguirRespuesta($db, $_GET['id']);
        ...
        <div class="dividir">
            <div class="ochenta">
                        ...
                        <div class="dividir">
                            ...
                            <div class="archivos">
                                ...
                                <?php if (!empty($entrada_actual['imagen']) || !empty($entrada_actual['imagen_2']) || !empty($entrada_actual['imagen_3']) || !empty($entrada_actual['imagen_4'])) : ?>
                                    ...
                                    <div class="dividir">
                                        <div class="dos-partes imagen-subida-entrada">
                ...
                <?php if (isset($_SESSION["usuario"]) && $_SESSION['usuario']['id'] == $entrada_actual['usuario_id']) : ?>
                    ...
                    <div class="centrar-texto link">
                        <p id="changa">Hola <span><?= $_SESSION['usuario']['nombre'] ?></span> detectamos que este es un comentario tuyo ¿Deseas realizar alguna acción?</p>
                        <a class="btn-general" href="editar-entrada.php?id=<?= $entrada_actual['id'] ?>"><i class="far fa-edit"></i> Editar comentario</a>

                        <a class="btn-general" href="borrar-entrada.php?id=<?= $entrada_actual['id'] ?>"><i class="far fa-trash-alt"></i> Eliminar comentario</a>
                    </div>
                <?php endif; ?>

                <section class="respuestas">
                    <?php if (isset($_SESSION['usuario'])) : ?>
                        <form class="formulario" action="guardar-entrada2.php" method="post">
                            <!--Hidden  del ID-->
                            ...
                            <input type="hidden" name="categoria" value="<?= $entrada_actual['titulo'] ?>">

                            <label for="">Escribe un comentario a la entrada <strong><?= $entrada_actual['titulo_comentario'] ?></strong> </label>
                            <textarea class="inputs" name="descripcion" placeholder="Escribe una respuesta..."></textarea>

                            <div class="texto-derecha">
                                <input class="btn-general" type="submit" onclick='alert("Su comentario se ha registrado, vuelva a visualizar el comentario para poder ver su respuesta")' value="Responder" />
                            </div>
                        </form>
                    <?php endif; ?>
                    ...
                    ?>
                            <p>Respuestas:</p>
                            <section class="respuestas-comentarios">

                                <div class="">
                                    <div class="dividir">
                                        <div class="fecha">
                                            <!--Respuesta de:-->
                                            <p>Fecha:<?= $entrada1['fecha'] ?></p>
                                        </div>
                                        <div class="usuario">
                                            <p> Respuesta de:<?= $entrada1['usuario'] ?></p>
                                        </div>
                                    </div>
                                    <!--Experiencia-->
                                </div>
            ...
            <div class="barra-externos-veinte">
                ...
                ?>
                        <?php if ($entrada_actual['categoria']) ?>
                        <div class="comentario-secundario">
                            <div class="fecha">
                                <?= $entrada_actual['fecha'] ?>
                            </div>
                            <div class="titulo">
                            ...
                            <div class="descripcion">
                                <?= substr($entrada_actual['descripcion'], 0, 100) . "..."  ?>
                            </div>

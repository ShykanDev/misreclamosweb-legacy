...
if($robot == 4){
    ...
    <body>
        ...
        <div class='contenedor'>
            ...
            <p>Hola, el usuario <span> $nombre </span> se ha comunicado con nosotros desde la página <strong>misreclamos.com</strong></h3>
                <div class='dividir'>
                    <div class='dos-partes'>
                ...
                <p class='centrar-texto'><strong><a href='http://www.misreclamos.com' target='_blank' rel='noopener noreferrer'>misreclamos.com</a> </strong> <span id='date'></span> Todos los derechos reservados. Design: JAAC
    ...
    $mail->Subject = "Mensaje de Usuario de la página misreclamos.com"; //Title of the message

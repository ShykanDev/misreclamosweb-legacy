...
<section class="site-comentarios contenedor">
    <div class="">
        <h2>Reclamos a diferentes empresas, marcas, personas, productos, servicios y más a tu disposición</h2>
        <p>Experiencias de empresas y marcas reconocidas</p>
    </div>

    <!--
    <nav class="marcas-blog">
        <a href=""><img src="./logos/sat.png" alt=""> </a>
        <a href=""><img src="./logos/huawei.png" alt=""></a>
        <a href=""><img src="./logos/dhl.png" alt=""></a>
        <a href=""><img src="./logos/uber.png" alt=""></a>
        <a href=""><img src="./logos/apple.png" alt=""></a>
    </nav>
-->
</section>
...
<section class="contenedor ">
    <div class="dividir alinear-vertical opciones-blog">
        <div class="tres-partes ">
            <a href="categoria.php?id=21">
                <div class="cuadro-rojo-2">
                    <p>Reclamos en el área tecnológica</p>
                    <p>Marcas como Apple, Microsoft, Huawei, Oppo y muchos más</p>
                </div>
            </a>
        </div>
        <div class="tres-partes">
            <a href="categoria.php?id=20">
                <div class="cuadro-verde">
                    <p>Reclamos en el área de automóviles</p>
                    <p>Marcas como Nissan, Ford, Volkswagen, Kia, Hiunday y muchos más</p>
                </div>
            </a>
        </div>
        <div class="tres-partes">
            <a href="categoria.php?id=33">
                <div class="cuadro-negro">
                    <p>Reclamos hacia los restaurantes</p>
                    <p>Restaurantes como Mc Donalds, VIPS, Burguer King, Domino´s y muchos más</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="dividir alinear-vertical opciones-blog">
        <div class="tres-partes">
            <a href="categoria.php?id=58">
                <div class="cuadro-gris">
                    <p>Reclamos hacia los supermercados </p>
                    <p>Tiendas como Walmart, Costco, Aurrera, Paris y muchos más </p>
                </div>
            </a>
        </div>
        <div class="tres-partes ">
            <a href="categoria.php?id=18">
                <div class="cuadro-verde-1">
                    <p>Reclamos en el área gubernamental</p>
                    <p>Secretarías, Instituciones, Independencias y muchos más</p>
                </div>
            </a>
        </div>
        <div class="tres-partes ">
            <a href="categoria.php?id=41">
                <div class="cuadro-rojo-3">
                    <p>Reclamos en el área de moda</p>
                    <p>Marcas como ZARA, Bershka, Tommy Hilfiger, Chanel y muchos más</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="centrar-texto">
        <a class="btn-general" href="./ver-categorias.php">Ver todas las categorías</a>
    </div>
</section>
    ...
    <div class="dividir">
        ...
        <div class="comentarios-sesenta">
            ...
            ?>
                ...
                <?php endwhile; ?>
                <div class="centrar-texto">
                    <a class="btn-general" href="./mas-entradas.php">Mostrar más comentarios</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="barra-externos-veinte">
            <div class="barra-lateral">
                <a href="https://oficiomaestro.com/index.php" target="_blank" rel="noopener noreferrer">
                    <div class="oficio">
                        <p>Comentarios de Profesionistas y Maestros</p>
                    </div>
                </a>

                <a href="https://losestafadores.com/" target="_blank" rel="noopener noreferrer">
                    <div class="estafadores">
                        <p>Comentarios hacia Estafadores y Fraudulentos</p>
                    </div>
                </a>

                <a href="https://miempleador.com/" target="_blank" rel="noopener noreferrer">
                    <div class="empleador">
                        <p>Comentarios de Empleados y Jefes</p>
                    </div>
                </a>

                <a href="https://marcasbuenas.com/" target="_blank" rel="noopener noreferrer">
                    <div class="marcas">
                        <p>Comentarios de marcas buenas y marcas malas</p>
                    </div>
                </a>

                <a href="https://miarrendador.com/" target="_blank" rel="noopener noreferrer">
                    <div class="arrendadores">
                        <p>Comentarios de Arrendadores y Arrendatarios</p>
                    </div>
                </a>
                <br>
                <div class="publicidad">
                    <fieldset>
                        <a href="https://maltratomenores.com/" target="_blank" rel="noopener noreferrer">
                            <legend>Publicidad</legend>
                            <img src="./img/anuncio-2.png" alt="">
                        </a>
                    </fieldset>
                </div>
            </div>

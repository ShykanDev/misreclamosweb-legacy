...
<div class="contenedor">
	<div class="barra-lateral buscar">
		<p>Resultados de la búsqueda: <?= $_POST['busqueda'] ?> </p>
	</div>
	<div class="dividir">
		<main class="veinte">
		...
		<div class="ochenta">
			<?php if ($_POST['busqueda']) : ?>
				...
				?>
					...
					?>
					<div class="error">
						<p>No existen comentarios relacionados a la marca: <?= $_POST['busqueda'] ?> </p>
					</div>
					<h2>Comparte tu experiencia con la marca: <?= $_POST['busqueda'] ?></h2>
					<p>Crea un comentario advirtiendo, recomendando u ofreciendo alguna sugerencia de forma gratuita</p>
					<?php if (isset($_SESSION['usuario'])) : ?>
						<a class="btn-general" href="./crear-entradas.php">Crear comentario acerca de la marca <?= $_POST['busqueda'] ?></a>
					<?php else : ?>
						<a class="btn-general" href="./register.php">Crear comentario acerca de la marca <?= $_POST['busqueda'] ?></a>
					<?php endif; ?>

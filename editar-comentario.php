    ...
    <section class="contenedor">
        <div class="dividir">
            ...
            <div class="setenta">
                ...
                <div class="contenedor">
                    <form class="formulario" action="guardar-entrada.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <input class="inputs" type="text" id="titulo" name="titulo" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
                        </div>
                        ...
                        <div class="">
                            ...
                            <input class="inputs" type="text" id="titulo-comentario" name="titulo_comentario" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
                        </div>

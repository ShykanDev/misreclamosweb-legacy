...
<section class="site-header-index">
    <div class="dividir">
        <div class="cincuenta-0">
            <div class="contenedor">
                <h1>Reclame con sus experiencias, descubra con las de otros</h1>
                <p>¿Tiene algún reclamo? Comente aquí sus experiencias y hagamos saber nuestras inconformidades que se tienen acerca de un servicio, empresa producto, persona y más</p>

                <div class="enlaces-index">
                    <p class="mayus" id="changa">Puedes conocer acerca de:</p>
                    <a href="categoria.php?id=14">Bancos <i class="fas fa-piggy-bank"></i></a>
                    <a href="categoria.php?id=18">Gobierno <i class="fas fa-landmark"></i></a>
                    <a href="categoria.php?id=26">Redes Sociales <i class="fab fa-facebook"></i></a>
                    <a href="categoria.php?id=25">Paqueteria y Correos <i class="fas fa-envelope-open-text"></i></a>
                    <a href="categoria.php?id=16">Salud <i class="fas fa-hospital-user"></i></a>
                    <a href="categoria.php?id=24">Transportes <i class="fas fa-bus-alt"></i></a>
                    <a href="categoria.php?id=51">Servicios de Streaming <i class="fas fa-satellite-dish"></i></a>
                    <a href="categoria.php?id=28">Hospedaje <i class="fas fa-h-square"></i></a>
                    <a href="categoria.php?id=33">Comida y Restaurantes <i class="fas fa-utensils"></i></a>

                    <?php if (!isset($_SESSION['usuario'])) : ?>
                        <div class="btn-index">
                            <a class="btn-general" href="./register.php">Registro gratis</a>
                        </div>
                    <?php endif; ?>

                    <?php if (isset($_SESSION['usuario'])) : ?>
                        <div class="btn-index">
                            <a class="btn-general" href="./crear-entradas.php">Crear Comentario</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="slider-composition">
            <div class="slider">
                <div class="slide-track">
                    <div class="slide">
                        <img src="./logos/cfe.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/fedex.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/sat.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/banco-azteca.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/banamex.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/telmex.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/estafeta.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/movistar.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/at&t.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/aeromexico.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/mapfre.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/banco-de-chile.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/axa.png" height="100" width="150" alt="" />
                    </div>
                    <div class="slide">
                        <img src="./logos/bancolombia.png" height="100" width="150" alt="" />
                    </div>
                </div>
            </div>
        </div>
...
<section class="contenedor">
    <div class="barra-inicio">
        <div class="dividir alinear-vertical">
            <div class="setenta">
                <h2>Comparte tus reclamos o visualiza los de los demás</h2>
                <p>En el sitio podrás encontrar comentarios de cualquier índole, podrás obtener referencias y advertir igual sobre algún producto o servicio</p>
            </div>
            <div class="treinta centrar-texto">
                <a class="btn-general" href="./nosotros.php">Conocer más</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="dividir">
        <div class="veinte">
            <aside class="barra-lateral">
                <!--BARRA LATERAL-->
                <div class="mostrar-128px">
                    <input type="checkbox" id="spoiler"></input>
                    <label class="mayus" id="changa" for="spoiler">CATEGORÍAS</label>
                    <div class="spoiler">
                        <?php
                ...
                <div class="mostrar-768px categorias">
                    <?php require_once 'barra-lateral.php'; ?>
                </div>
            </aside>
        </div>

        <div class="comentarios-sesenta">
            <section class="barra-lateral botones">
                <div class="dividir">
                    <div class="cuarenta-0">
                        <a href="./crear-entradas.php">
                            <div class="crear start alinear-vertical ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message-2" width="36" height="36" viewBox="0 0 24 24" stroke-width="0.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M12 20l-3 -3h-2a3 3 0 0 1 -3 -3v-6a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-2l-3 3" />
                                    <line x1="8" y1="9" x2="16" y2="9" />
                                    <line x1="8" y1="13" x2="14" y2="13" />
                                </svg>
                                <h3>Crear comentarios</h3>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="treinta ">
                        <a href="./ayuda.php">
                            <div class="crear start alinear-vertical ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help" width="36" height="36" viewBox="0 0 24 24" stroke-width="0.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div class="treinta-0 ">
                        <a href="./ver-categorias.php">
                            <div class="crear start alinear-vertical ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="36" height="36" viewBox="0 0 24 24" stroke-width="0.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <?php
            $entradas = conseguirCincoEntradas($db, true);
            if (!empty($entradas)) :
                while ($entrada_actual = mysqli_fetch_assoc($entradas)) :
            ?>
                    ...
                    <article class="comentario">
                        ...
                        <div class="contenedor">
                            <div class="descripcion">
                                <?= substr($entrada_actual['descripcion'], 0, 200) . "..."  ?>
                            ...
                            <div class="dividir">
                                ...
                                <div class="dos-partes">
                                    <div class="texto-derecha">
                                        <?php if (isset($_SESSION['usuario'])) : ?>
                                            <a class="btn-general" href="entrada.php?id=<?= $entrada_actual['id'] ?>">Visualizar Comentario <i class="fas fa-angle-right"></i></a>
                                        <?php endif; ?>

                                        <?php if (!isset($_SESSION['usuario'])) : ?>
                                            <a class="btn-general" href="login-required.php">Visualizar Comentario <i class="fas fa-angle-right"></i></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="centrar-texto">
                    <a class="btn-general" href="./blog.php">Mostrar más comentarios</a>
                </div>
            <?php endif; ?>
        </div>

        <div class="barra-externos-veinte">
            ...
            <div class="barra-lateral publicidad">
                <fieldset>
                    <a href="https://miexpareja.net/" target="_blank" rel="noopener noreferrer">
                        <legend>Publicidad</legend>
                        <img src="./img/anuncio-1.png" alt="">
                    </a>
                </fieldset>
            </div>
        </div>
